...
<div class="all-title-box">
				...
				<?php
								...
								");
                                    ...
                                    if (mysqli_num_rows($query) == 0) {
                                        ...
                                        header('location:test_result.php?id='.$id);
                                        ob_end_flush();
                                    } else {
                                            ...
                                            for ($i = 1; $i <= 4; ++$i) {
												...
												<div class="col-md-6" style="margin-top:5px;">
													<div class="blog-button">
														<a class="hover-btn-new orange" href="javascript:void(0)" style="width: 91%; height: 48px;text-align:center" data-option="'.$row['option'.$i].'" id="option'.$i.'" name="option'.$i.'" onclick="SubmitQuestion(this,\'test_paper.php?id='.@$id.'&page='.(@$page + 1).'\');"><span>'.$row['option'.$i].'<span></a>
													</div>
												</div>
    ...
    <script type="text/javascript" src="js/snippets/preparepaper.js"></script>
