						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
                                ...
                                <?php
                                    ...
                                    echo '  <h1 class="text-center" style="font-family: "Times New Roman", Times, serif;">'.$row['chapter_name'].'</h1>
                                            <h1 style="font-family: "Times New Roman", Times, serif;">Topic List</h1>';
                                ?>          
                                </div>
                                        ...
                                        <?php
                                             ...
                                             if(mysqli_num_rows($query) > 0){
                                                 while($row=mysqli_fetch_assoc($query)){
                                                     echo '<li><a href="preparetopic.php?id='.$row['id'].'" >'.$row['topic_name'].'</a></li>';
                                                 }
                                             }
                                             else{
                                                 echo 'No Topic Found';
