						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
                                ...
                                <?php
                                    ...
                                    echo '<h1 class="text-center" style="font-family: "Times New Roman", Times, serif;font-size:30px">'.$row['subject_name'].'</h1>
                                          <h1 style="font-family: "Times New Roman", Times, serif;font-size:30px">Chapter</h1>';
                                ?>
                                </div>
                                        ...
                                        <?php
                                            ...
                                            if(mysqli_num_rows($query) > 0){
                                                while($row=mysqli_fetch_assoc($query)){
                                                    echo '<li class="cs-a">'.$a++.'.<a href= "topiclist.php?id='.$row['id'].'" >'.$row['chapter_name'].'</a></li>';
                                                }
                                            }
                                            else{
