							...
							<div class="single-post row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12  justify-content-center align-items-center d-flex relative">';
										...
										<div class="quotes" style="font-size:13px;">
												'.$row['topic_article'].'
										</div>
										<div class="col-md-12" style="text-align: center; margin-top: 1%;">
											
											<a href="paper.php?id='.$row['id'].'" class="genric-btn primary-border">Take A Question</a>											
										</div>';
                                            }
