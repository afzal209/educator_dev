...
?>
									...
									if(mysqli_num_rows($query) == 0){ 
										...
										//         //echo '<pre>'.print_r($row,true).'<pre>';
											...
											echo'	<div  class="col-md-12 col-sm-12 table-responsive" style="margin-top:2%;">
													...
													<a href="session/preparepaper/prepare_session_next.php?id='.$id.'" class="genric-btn primary">Next Topic</a> <a href="session/preparepaper/prepare_session_finish.php" class="genric-btn primary-border">Finish</a>';
									}
									else{
										while($row=mysqli_fetch_array($query)){
											...
											<p style="text-align: center;font-size: 20px;" >Question&nbsp'.$page.' of '.$row1['total'].' </p>
											<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
												<hr>
											</div>
											...
											';
													for ($i=1; $i<=4 ; $i++) { 
														...
														<div class="col-lg-6 col-md-12 col-sm-12">
															<button type="button" class="genric-btn  e-large btn_size"  data-option="'.$row['option'.$i].'" id="option'.$i.'" name="option'.$i.'" onclick="SubmitQuestion(this,\'preparepaper.php?id='.@$id.'&page='.(@$page+1).'\');" >'.$row['option'.$i].'</button>	
														</div>
														';	
													}
													echo '
    		...
    		<script type="text/javascript" src="assets/js/snippets/preparepaper.js"></script>
