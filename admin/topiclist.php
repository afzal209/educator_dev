						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
                                ...
                                <?php
                                    ...
                                    echo '  <h1 class="text-center" style="font-family: Arial, Helvetica, sans-serif;font-size:30px">'.$row['chapter_name'].'</h1>
                                            <h1 style="font-family: Arial, Helvetica, sans-serif;font-size:30px">Topic List</h1>';
                                ?>
                                </div>
                                        ...
                                        <?php
                                            ...
                                            if(mysqli_num_rows($query) > 0){
                                                while($row=mysqli_fetch_assoc($query)){
                                                    echo '<li class="cs-a">'.$a++.'.<a href= "topic.php?id='.$row['id'].'" >'.$row['topic_name'].'</a></li>';
                                                }
                                            }
                                            else{
