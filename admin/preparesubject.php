						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <h1 class="text-center" style="font-family: 'Times New Roman', Times, serif;font-size:30px">Subject</h1>
                                </div>
                                        ...
                                        <?php
                                            ...
                                            if(mysqli_num_rows($query) > 0){
                                                while($row=mysqli_fetch_assoc($query)){
                                                    echo '<li class="cs-a">'.$a++.'.<a href="preparechapter.php?id='.$row['id'].'" >'.$row['subject_name'].'</a></li>';
                                                }
                                            }
                                            else{
