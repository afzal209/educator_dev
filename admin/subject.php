						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
                                ...
                                <?php
                                    ...
                                    echo '<h3 class="text-center" style="font-family: "Times New Roman", Times, serif;">'.$row['academic_name'].'</h3>
                                          <h3 style="font-family: "Times New Roman", Times, serif;">Subject</h3>';
                                ?>
                                </div>
                                        ...
                                        <?php
                                            ...
                                            if(mysqli_num_rows($query) > 0){
                                                while($row=mysqli_fetch_assoc($query)){
                                                    echo '<li class="cs-a">'.$a++.'.<a href= "chapter.php?id='.$row['id'].'" >'.$row['subject_name'].'</a></li>';
                                                }
                                            }
                                            else{
