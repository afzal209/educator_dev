                ...
                <div class="col-lg-9 blog-post-single">
                            ...
                            while ($row = mysqli_fetch_assoc($query)) {
                                echo '	<div class="col-md-6" style="margin-top:5px;">
                                            <div class="blog-button">
                                                <a class="hover-btn-new orange" href="test_topic.php?id='.$row['id'].'" style="width: 91%; height: 48px;text-align:center"><span>'.$row['topic_name'].'<span></a>
                                            </div>
                                        </div>';
                            }
                        } else {
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        if (mysqli_num_rows($query) > 0) {
                            while ($row = mysqli_fetch_assoc($query)) {
                                echo '	<div class="col-md-6" style="margin-top:5px;">
                                            <div class="blog-button">
                                                <a class="hover-btn-new orange" href="test_topic.php?id='.$row['id'].'" style="width: 91%; height: 48px;text-align:center"><span>'.$row['chapter_name'].'<span></a>
                                            </div>
                                        </div>';
                            }
                        } else {
					...
					<div class="blog-item">
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            echo '	<div class="col-md-6" style="margin-top:5px;">
										<div class="blog-button">
											<a class="hover-btn-new orange" href="test_chapter.php?id='.$row['id'].'" style="width: 91%; height: 48px;text-align:center"><span>'.$row['subject_name'].'<span></a>
										</div>
									</div>';
                        }
                        ?>
